...
`,
  repaso: {
    intro: "Preguntas de repaso que pasó el profe (Poder Tributario y Derecho Financiero). Verdadero/Falso y Completar suman puntaje; en Análisis podés ver la respuesta modelo.",
    vf: [
      { q:"El poder tributario es indelegable porque, al ser originario de la Constitución Nacional, resulta imposible su delegación.", v:false,
        exp:"Falso. La indelegabilidad no deriva de ser \"imposible\" por origen constitucional, sino que es un carácter ligado a la soberanía/imperio estatal. De hecho existe el poder tributario derivado (ej. municipios), lo que muestra que sí hay delegación en algún grado." },
      { q:"El poder tributario prescribe una vez transcurrido el plazo que fije la ley de coparticipación federal de impuestos.", v:false,
        exp:"Falso. El poder tributario es permanente, no prescribe. Lo que puede prescribir es la acción para exigir el crédito tributario ya nacido (plazos de la Ley 11.683), y eso no tiene relación con la ley de coparticipación." },
      { q:"Los municipios poseen poder tributario originario, en igual medida que la Nación y las provincias.", v:false,
        exp:"Falso. Según la doctrina mayoritaria (Villegas), los municipios tienen poder tributario derivado: lo ejercen en la medida y forma que les reconocen las constituciones y leyes provinciales." },
      { q:"Las provincias tienen poder tributario originario por ser preexistentes a la Nación.", v:true,
        exp:"Verdadero. Las provincias son preexistentes históricamente a la Nación y conservan todo el poder no delegado (art. 121 CN), por eso su poder tributario es originario." },
      { q:"El derecho financiero es considerado, según Villegas, una rama del derecho privado.", v:false,
        exp:"Falso. Para Villegas el derecho financiero es una rama del derecho público, ya que regula la actividad financiera del Estado." },
      { q:"Según Villegas, el derecho financiero regula la actividad financiera del Estado orgánicamente considerada y las relaciones que dan lugar a la adquisición, conservación y empleo de sus medios económicos.", v:true,
        exp:"Verdadero. Es prácticamente la definición textual de Villegas de derecho financiero." },
      { q:"La Constitución Nacional contiene un capítulo específico y unificado dedicado a la materia financiera.", v:false,
        exp:"Falso. La CN no tiene un capítulo unificado sobre finanzas; las normas financieras están dispersas en distintos artículos (arts. 4, 9, 17, 52, 75 incs. 1, 2, 3, 8, etc.)." },
      { q:"Como regla general, las leyes tributarias no tienen efecto retroactivo, salvo disposición en contrario que no afecte derechos amparados por garantías constitucionales.", v:true,
        exp:"Verdadero. Es la regla general de irretroactividad (art. 7 CCyC) aplicada a la materia tributaria, con el límite de los derechos adquiridos amparados constitucionalmente." },
      { q:"Los impuestos directos son, en principio, facultad exclusiva y permanente de la Nación.", v:false,
        exp:"Falso, es al revés. Los impuestos directos son en principio facultad de las provincias (exclusiva y permanente); la Nación solo puede establecerlos excepcionalmente, por tiempo determinado y bajo ciertas condiciones (art. 75 inc. 2 CN)." },
      { q:"El principio de legalidad tributaria implica que no puede exigirse ningún tributo que no esté establecido por ley.", v:true,
        exp:"Verdadero. \"Nullum tributum sine lege\": ningún tributo puede crearse, modificarse ni exigirse sin ley previa que lo establezca." }
    ],
    fill: [
      { q:"El poder tributario es la facultad del Estado para crear ______ tributos.", resp:["modificar y extinguir","modificar, extinguir y exigir","modificar"], sol:"modificar y extinguir" },
      { q:"Según Villegas, el derecho financiero es el \"conjunto de normas jurídicas que regulan la ______, orgánicamente considerada...\".", resp:["actividad financiera del estado","actividad financiera"], sol:"actividad financiera del Estado" },
      { q:"La ley que funciona como código tributario para los tributos nacionales en Argentina es la Ley N° ______, sancionada el 4/1/1933.", resp:["11683","11.683"], sol:"11.683" },
      { q:"El principio de legalidad tributaria se resume en la máxima \"no hay tributo sin ______ que lo establezca\".", resp:["ley"], sol:"ley" },
      { q:"El artículo ______ de la Constitución Nacional establece que las provincias conservan todo el poder no delegado por la Constitución al Gobierno Federal.", resp:["121"], sol:"121" },
      { q:"La ______ es la aptitud económica de los miembros de la comunidad para contribuir a la cobertura de los gastos públicos.", resp:["capacidad contributiva"], sol:"capacidad contributiva" },
      { q:"Según la CSJN, un tributo es ______ cuando absorbe una parte sustancial de la propiedad o de la renta.", resp:["confiscatorio"], sol:"confiscatorio" },
      { q:"El derecho tributario se divide en Parte General y Parte ______.", resp:["especial"], sol:"especial" },
      { q:"La ley de administración financiera del sector público nacional es la Ley N° ______.", resp:["24156","24.156"], sol:"24.156" },
      { q:"Los gravámenes que los municipios pueden cobrar por servicios efectivamente prestados se denominan ______ y no impuestos.", resp:["tasas","tasa"], sol:"tasas" }
    ],
    analisis: [
      { q:"Explique la diferencia entre poder tributario originario y derivado, y ejemplifique esta distinción con el caso de los municipios.",
        a:"El poder tributario originario nace directamente de la Constitución, sin necesidad de que otro ente se lo transfiera: lo tienen la Nación y las provincias (estas últimas por ser preexistentes, art. 121 CN). El poder tributario derivado, en cambio, surge de una atribución o delegación hecha por un ente que sí tiene poder originario. Los municipios son el ejemplo clásico: la doctrina mayoritaria (Villegas) sostiene que su poder es derivado, porque lo ejercen dentro de los límites y con el alcance que les reconocen las constituciones y leyes provinciales, no de forma autónoma e ilimitada." },
      { q:"Analice por qué el poder tributario se caracteriza como abstracto, permanente, irrenunciable e indelegable. Desarrolle brevemente cada carácter.",
        a:"Abstracto: existe como potestad jurídica con independencia de que se ejerza en un caso concreto (es la posibilidad de gravar, no el tributo ya creado). Permanente: subsiste mientras exista el Estado, no se extingue por el paso del tiempo ni por falta de uso. Irrenunciable: el Estado no puede desprenderse de esta potestad, porque hace a su soberanía y a la satisfacción de necesidades públicas. Indelegable: los poderes del Estado (Legislativo, Ejecutivo) no pueden transferir a otro órgano la facultad de crear tributos sin base constitucional o legal que lo habilite, en resguardo del principio de legalidad." },
      { q:"Un municipio sanciona una ordenanza creando un impuesto sobre la actividad comercial dentro de su ejido, análogo a un impuesto nacional coparticipado. Analice la validez de esa norma a la luz de la Ley de Coparticipación Federal de Impuestos (Ley 23.548, art. 9 inc. b).",
        a:"La ordenanza sería inválida. El art. 9 inc. b de la Ley 23.548 obliga a las provincias adheridas (y, a través de ellas, a sus municipios) a no aplicar gravámenes locales análogos a los impuestos nacionales coparticipados. Un impuesto municipal a la actividad comercial que reproduzca el hecho imponible de un tributo nacional coparticipado (por ejemplo, análogo a Ingresos Brutos/IVA) vulneraría ese compromiso y expondría a la provincia a perder su participación en la coparticipación, además de ser cuestionable constitucionalmente por avanzar sobre facultades no delegadas al municipio." },
      { q:"Compare el principio de legalidad con el principio de capacidad contributiva como límites al ejercicio del poder tributario.",
        a:"El principio de legalidad es un límite formal: exige que todo tributo (hecho imponible, sujetos, alícuota, exenciones) sea creado por ley emanada del órgano competente, resguardando la garantía de que no hay tributación sin representación. El principio de capacidad contributiva es un límite material o sustancial: exige que el tributo recaiga sobre una manifestación real de riqueza (renta, patrimonio, consumo) y que su magnitud sea razonable, evitando la confiscatoriedad. Uno controla el \"cómo\" se crea el tributo (procedimiento), el otro controla el \"sobre qué\" y \"cuánto\" se puede gravar (contenido)." },
      { q:"Explique en qué consisten la retroactividad, la irretroactividad y la ultraactividad de la ley, y señale qué regla general adopta el Código Civil y Comercial en su artículo 7.",
        a:"Retroactividad: la ley se aplica a hechos o situaciones ocurridos antes de su entrada en vigencia. Irretroactividad: la ley rige solo para el futuro, sin afectar situaciones consumadas bajo la ley anterior. Ultraactividad: una ley ya derogada sigue aplicándose a situaciones nacidas bajo su vigencia, aun después de su derogación. El art. 7 del CCyC adopta como regla general la aplicación inmediata de la nueva ley a las consecuencias de las relaciones y situaciones jurídicas existentes, sin efecto retroactivo salvo disposición en contrario, y siempre respetando garantías constitucionales." },
      { q:"Un contribuyente celebra un contrato bajo una forma jurídica atípica con el fin de reducir su carga tributaria, aunque la operación económica real coincide con un hecho imponible gravado. Analice cómo resolvería esta situación el principio de la realidad económica (art. 2, Ley 11.683).",
        a:"El principio de la realidad económica (art. 2, Ley 11.683) faculta al fisco a prescindir de las formas jurídicas utilizadas por el contribuyente cuando estas resulten manifiestamente inadecuadas para reflejar la real intención económica del acto, y a considerar en cambio la situación económica efectiva. En el caso planteado, si la sustancia económica de la operación encuadra en el hecho imponible aunque la forma elegida intente evitarlo, el fisco puede recalificar el acto y exigir el tributo correspondiente a la realidad económica subyacente, combatiendo así el abuso de formas con fines de evasión o elusión." },
      { q:"Desarrolle las tres formas de codificación tributaria (limitada, amplia y total) y explique cuál de ellas rige actualmente en la legislación tributaria nacional argentina.",
        a:"Codificación limitada: se codifican solo los principios generales y las normas de procedimiento aplicables a todos los tributos, dejando las leyes de cada gravamen por separado. Codificación amplia: además de los principios generales se incorporan también las normas sustantivas de los principales tributos. Codificación total: se pretende unificar en un único cuerpo tanto la parte general como la totalidad del derecho tributario sustantivo, procesal y penal. En Argentina rige, en los hechos, una codificación limitada: la Ley 11.683 fija los principios generales y el procedimiento para los tributos nacionales, pero cada impuesto (Ganancias, IVA, Bienes Personales, etc.) tiene su propia ley especial." },
      { q:"Explique el fundamento de la discusión doctrinaria sobre la autonomía del derecho tributario y mencione al menos dos posturas distintas al respecto.",
        a:"La discusión gira en torno a si el derecho tributario tiene principios, conceptos e institutos propios que lo distinguen del resto del ordenamiento (autonomía) o si, por el contrario, es solo una rama del derecho administrativo o financiero que aplica categorías generales del derecho a la materia fiscal. Entre las posturas: (1) los que niegan autonomía y lo consideran parte del derecho financiero o administrativo (sin sustantividad propia); (2) los que sostienen una autonomía didáctica o funcional, reconociendo particularidades (como el hecho imponible o la realidad económica) sin que ello implique independencia total del resto del derecho; y (3) los que defienden una autonomía plena, con principios propios que incluso permiten apartarse de figuras del derecho privado cuando la ley tributaria así lo dispone." },
      { q:"Explique el rol del Poder Judicial en el control de constitucionalidad de los tributos.",
        a:"El Poder Judicial ejerce el control de constitucionalidad de los tributos verificando que respeten los límites formales (legalidad) y materiales (capacidad contributiva, no confiscatoriedad, igualdad, razonabilidad) impuestos por la Constitución. En el sistema argentino ese control es difuso y se ejerce dentro de un caso o controversia real entre partes, con efecto para las partes del pleito; tradicionalmente se exigía pedido de parte, aunque la CSJN admite hoy el control de oficio (\"Rodríguez Pereyra\", 2012). La justicia federal revisa los tributos nacionales y la provincial los locales, sin perjuicio del recurso extraordinario ante la CSJN." },
      { q:"A partir de la distribución constitucional explícita de facultades impositivas (arts. 4°, 9°, 75 incs. 1° y 2°, y 121 de la CN), explique qué impuestos corresponden exclusivamente a la Nación, cuáles son concurrentes entre Nación y provincias, y cuáles son de competencia provincial exclusiva.",
        a:"Exclusivos de la Nación: los derechos de importación y exportación (impuestos indirectos externos o aduaneros, arts. 4° y 9°, y 75 inc. 1°), por ser inherentes a la soberanía y política de comercio exterior. Concurrentes entre Nación y provincias: los impuestos indirectos internos (por ejemplo, al consumo), que ambos niveles pueden establecer permanentemente (art. 75 inc. 2°). De competencia provincial exclusiva y permanente (con la excepción constitucional ya vista): los impuestos directos, que la Nación solo puede imponer transitoriamente y bajo ciertas condiciones, mientras que las provincias los retienen como poder no delegado (art. 121 CN)." }
    ]
  }
});
